...
<head>
    ...
    <title>
        Upcoming Real Estate Projects in Jhansi | Dream World Real Estate
    </title>
...
content="Explore upcoming real estate projects, residential plots, villas and investment opportunities by Dream World Real Estate in Jhansi.">
<link rel="canonical" href="https://dreamworldrealestate.in/projects.php">
    <!-- Google Font -->
<!-- Favicon -->
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-9 text-center">
                    ...
                    <div class="page-banner-content"
                        ...
                        <p>
                            Discover luxury townships, modern apartments,
                            villas, duplexes, and premium investment projects.
                        </p>
...
<section class="section-padding bg-light-custom">
    ...
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <?php while($row = mysqli_fetch_assoc($projectQuery)){ ?>
